...
var patterns = map[string]string{
	...
	"MODSECSCOREERROR":   `\"Inbound Anomaly Score Exceeded \(Total Inbound Score: %{NUMBER:[modsecurity-error][score]:int}%{GREEDYDATA:[modsecurity-error][rulemessage]}`,
	"MODSECSCOREAUDIT":   `\[msg \"Inbound Anomaly Score Exceeded \(Total Inbound Score: %{NUMBER:[modsecurity-audit][score]:int}%{GREEDYDATA:[modsecurity-audit][rulemessage]}\]`,
	"MODSECRULEMSG":      `\[msg (?:%{MODSECSCOREERROR}|%{QUOTEDSTRING:[modsecurity-error][rulemessage]})\]`,
